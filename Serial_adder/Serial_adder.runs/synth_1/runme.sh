...
HD_PWD='E:/Sem-2/HW-SW/SOC-lab-vivado/Serial_adder/Serial_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SADP.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SADP.tcl
